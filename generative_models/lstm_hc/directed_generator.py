...
from generator import SmilesRnnMoleculeGenerator
from utils import load_rnn_model
...
class SmilesRnnDirectedGenerator: # (GoalDirectedGenerator):
    ...
    def generate_optimized_molecules(self, scoring_function, number_molecules: int,
        ...
        # samples = canonicalize_list(samples)  # Canonicalized in MolScore
        scores = scoring_function(samples, flt=True)
