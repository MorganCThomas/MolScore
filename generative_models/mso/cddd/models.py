...
class GRUSeq2Seq(BaseModel):
    ...
    def _decoder(self, encoded_seq, decoder_emb_inp=None):
        ...
        decoder_cell_initial = tf.layers.dense(encoded_seq, sum(self.cell_size))
        decoder_cell_initial = tuple(tf.split(decoder_cell_initial, self.cell_size, 1))
        ...
        if self.mode != "DECODE":
            ...
            decoder = tf.contrib.seq2seq.BasicDecoder(cell=decoder_cell,
                                                      helper=helper,
                                                      initial_state=decoder_cell_initial,
            ...
            decorder_cell_initial = tf.contrib.seq2seq.tile_batch(decoder_cell_initial,
                                                         self.beam_width)
            ...
            decoder = tf.contrib.seq2seq.BeamSearchDecoder(
                ...
                end_token=end_token,
                initial_state=decorder_cell_initial,
