...
test_files = {
    ...
    'DRD2_rdock_constraint': os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data', 'DRD2_3x32.restr'),
    'chemprop_model': os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data', 'chemprop_model'),
}