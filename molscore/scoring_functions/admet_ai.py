    ...
    def __init__(
        ...
        **kwargs):
        ...
        super().__init__(
            ...
            env_name='admet_ai',
            env_path=resources.files("molscore.data.models.chemprop.admet_ai").joinpath('admet_ai.yml'),
            server_path=resources.files("molscore.scoring_functions.servers").joinpath('admet_ai_server.py'),
            server_grace=30,
            )