    ...
    def __init__(
        ...
        **kwargs):
        ...
        super().__init__(
            ...
            env_name='chemprop',
            env_path=resources.files("molscore.data.models.chemprop").joinpath('chemprop.yml'),
            server_path=resources.files("molscore.scoring_functions.servers").joinpath('chemprop_server.py'),
            server_grace=30,
